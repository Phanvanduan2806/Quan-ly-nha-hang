    ...
    fetch('http://localhost:3000/foods')
        ...
        .then(data => {
            ...
            data.forEach(food => {
                ...
                <div class="item__Foods">
                    <div class="edit__food">
                        <button type="button" class="btn" id="edit_food_name">
                ...
                <div class="food__name">
                    <span class="foodName__content">${foodName}</span>
                </div>
          ...
          `;
                ...
                // Edit tên thức ăn
                // const foodNameContent = listItem.querySelector('.foodName__content');
                // const BtnEditFoodName = listItem.getElementById('edit_food_name');
                // BtnEditFoodName.addEventListener('click',() => {
