...
function tablePosts() {
    ...
    boxElement[1].style.display = "block";
    contentMenuTo[1].classList.add('nav--link--active');
    contentMenuNho[1].classList.add('nav--link--active');
    contentMenuMin[1].classList.add('nav--link--active');
}
